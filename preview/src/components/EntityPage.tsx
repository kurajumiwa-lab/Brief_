...
const T = { muted: 'rgba(13, 17, 23,0.62)', ink: '#0D1117', line: '#E5E8EC', surface: '#FFFFFF', primary: '#2563EB', deep: '#C8963E', dark: '#0D1117' };
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1 py-0.5">
        ...
        <h4 className="mt-0.5 line-clamp-2 text-[13px] font-semibold leading-snug text-[#0D1117] group-hover:text-[#C8963E]">
          {o.title}
        </h4>
  ...
  return (
    <section aria-label={title}>
      <div className="mb-2 flex items-center gap-2">
        ...
        <span className="rounded-full bg-[#F0F2F5] px-2 py-0.5 text-[10px] font-bold text-[#C8963E]">
          {count}
        </span>
      </div>
        ...
        <div className="flex-1 overflow-y-auto pb-safe">
          ...
          {status === 'notfound' && (
            <div className="flex flex-col items-center justify-center gap-2 px-6 py-24 text-center">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#F0F2F5] text-[#C8963E]">
          ...
          {status === 'error' && (
            <div className="flex flex-col items-center justify-center gap-3 py-24 text-center">
              ...
              <button
                type="button"
                onClick={load}
                className="rounded-full bg-[#C8963E] px-4 py-2 text-[12px] font-bold text-[#0D1117]"
              >
                Try again
              </button>
            </div>
            ...
            <>
              ...
              {entity.imageUrl ? (
                ...
                <div className="relative h-32 bg-gradient-to-br from-[#EFF1F4] via-[#F0F2F5] to-[#E5E8EC] sm:h-40">
                  <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle at 20% 30%, #2563EB 0, transparent 45%), radial-gradient(circle at 80% 70%, #C8963E 0, transparent 40%)' }} />
                </div>
              )}
              ...
              <div className="relative px-4 sm:px-6">
                <div className="-mt-8 flex flex-wrap items-end gap-3">
                  {entity.imageUrl ? (
                    ...
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-[#FFFFFF] bg-gradient-to-br from-[#C8963E] to-[#EFF1F4] text-[#0D1117] shadow-lg">
                      {kindMeta.icon}
                    </div>
                  )}
                  <div className="flex-1 pb-1">
                    <div className="flex items-center gap-2">
                      <span className="rounded-full bg-[#F0F2F5] px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-[0.12em] text-[#C8963E]">
                        {kindMeta.label}
                      </span>
                  ...
                  <button
                    ...
                    className={`mb-1 flex items-center gap-1.5 rounded-full px-4 py-2.5 text-[13px] font-bold transition-colors ${
                      entity.isFollowed
                        ? 'border border-[#2563EB]/40 bg-[#F0F2F5] text-[#C8963E] hover:bg-[#EFF1F4]'
                        : 'bg-[#C8963E] text-[#0D1117] hover:bg-[#EFF1F4]'
                    }`}
                  >
                ...
                <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] font-semibold text-[rgba(13, 17, 23,0.62)]">
                  {(entity.location?.area || entity.location?.county) && (
                    <button
                      ...
                      className="flex items-center gap-1 rounded-full bg-[#F0F2F5] px-2 py-0.5 text-[10px] font-bold text-[#C8963E] transition-colors hover:bg-[#C8963E] hover:text-[#0D1117]"
                ...
                {!entity.trust.degraded && entity.trust.corroborated && (
                  <p className="mt-2 flex items-center gap-1.5 text-[11px] font-semibold text-[rgba(13, 17, 23,0.62)]">
                    <Check className="h-3.5 w-3.5 text-[#C8963E]" />
