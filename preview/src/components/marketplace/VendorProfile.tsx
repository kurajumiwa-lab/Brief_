  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-[color:var(--color-paper)] border border-[var(--brief-line)] rounded-2xl p-4 space-y-2">
        ...
        {vendor.description && (
          <p className="text-xs text-[var(--ink-60)] whitespace-pre-wrap">{vendor.description}</p>
        )}
      ...
      <div className="bg-[color:var(--color-paper)] border border-[var(--brief-line)] rounded-2xl p-4 space-y-2">
        ...
        {evidence.length === 0 ? (
          ...
          <ul className="space-y-1">
            {evidence.map((e) => (
              <li key={e.kind} className="text-xs text-[var(--brief-ink)]">
                {e.label}
              </li>
            ))}
          </ul>
      ...
      <div className="space-y-2">
        ...
        {listings.length === 0 ? (
          <p className="text-xs text-[var(--ink-60)]">This seller has nothing listed right now.</p>
        ) : (
