  ...
  if (resolvedId) {
    return (
      <button
        ...
        className={`inline-flex items-center rounded-full bg-[#F0F2F5] px-2 py-0.5 text-[9px] font-bold text-[#4F46E5] transition-colors hover:bg-[#4F46E5] hover:text-[#0D1117] ${className ?? ''}`}
        title={`Open ${name}`}
      >
        {text}
      </button>
