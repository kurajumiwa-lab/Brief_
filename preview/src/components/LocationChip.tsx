  ...
  return (
    <div className="relative">
      <button
        ...
        aria-expanded={open}
        className="flex items-center gap-1.5 bg-[#FFFFFF] text-[#0D1117] text-xs font-bold px-3 py-1.5 rounded-full border border-[#E5E8EC] hover:border-[#06B6D4] transition-colors cursor-pointer"
      >
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                ...
                className="h-9 w-9 flex items-center justify-center rounded-full bg-[#FFFFFF] border border-[#E5E8EC] text-[#0D1117] text-[18px] font-light hover:border-[#4F46E5] cursor-pointer"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <button
              type="button"
              onClick={() => { onLocate(); }}
              className="flex w-full items-center gap-3 rounded-2xl bg-[#4F46E5] px-4 py-3.5 text-left text-[13px] font-extrabold text-[#0D1117] cursor-pointer transition-opacity hover:opacity-90"
            >
