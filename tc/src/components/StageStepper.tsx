            ...
            <div className="flex min-w-[72px] flex-1 flex-col items-center text-center">
              <div
                ...
                style={{
                  ...
                  borderColor: done || active ? '#111111' : '#E5E7EB',
              ...
              <p
                ...
                style={{ color: active ? '#111111' : done ? 'rgba(17,17,17,0.7)' : 'rgba(17,17,17,0.4)' }}
              >
                {stage.label}
              </p>
              {!compact && stage.blurb && (
                <p className="mt-0.5 hidden text-[8px] leading-tight text-[#111111]/40 sm:block">{stage.blurb}</p>
              )}
            </div>
            {!isLast && (
              <div className="flex items-center pt-[15px] px-0.5" aria-hidden="true">
                <div
                  ...
                  style={{ background: i < currentIndex ? '#111111' : '#E5E7EB' }}
                />
              </div>
            )}
          </React.Fragment>
