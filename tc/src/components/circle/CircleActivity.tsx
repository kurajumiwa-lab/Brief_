      ...
      {rows.length === 0 ? (
        ...
        <div className="space-y-1.5">
          {rows.map((signal) => (
            <div
              key={signal.id}
              className="flex items-center gap-3 bg-[#12151A] border border-[#222630] rounded-xl px-3 py-2"
            >
              <span className="text-[10px] text-[#F7F7F8] min-w-0 truncate">
              ...
              <span className="text-[9px] text-[#F7F7F8]/40 shrink-0 ml-auto">
