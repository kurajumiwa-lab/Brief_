      ...
      {rows.length === 0 ? (
        ...
        <div className="space-y-1.5">
          {rows.map((signal) => (
            <div
              key={signal.id}
              className="flex items-center gap-3 bg-[#1C1C1F] border border-[#1E1E22] rounded-xl px-3 py-2"
            >
              <span className="text-[10px] text-[#FFFFFF] min-w-0 truncate">
              ...
              <span className="text-[9px] text-[#48484A] shrink-0 ml-auto">
