      ...
      {rows.length === 0 ? (
        ...
        <div className="space-y-1.5">
          {rows.map((signal) => (
            <div
              key={signal.id}
              className="flex items-center gap-3 bg-[#10141C] border border-[#232A38] rounded-xl px-3 py-2"
            >
              <span className="text-[10px] text-[#F3F1E7] min-w-0 truncate">
              ...
              <span className="text-[9px] text-[#4B5162] shrink-0 ml-auto">
