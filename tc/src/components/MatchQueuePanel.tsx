...
export function MatchQueuePanel({
  ...
  return (
    <div className="rounded-2xl border border-[#E5E7EB] bg-[#FFFFFF] p-4 space-y-3.5">
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          <p className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-[#111111]">Match queue</p>
          <p className="text-[10px] text-[#111111]/60 truncate">{gameName} · open play or ranked</p>
        </div>
        ...
        <button
          ...
          style={{
            background: availabilityOn ? '#111111' : '#FAFAFA',
            color: availabilityOn ? '#FFFFFF' : '#111111',
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] font-bold text-[#111111]/60">Mode</span>
          {(['friendly', 'ranked'] as const).map((m) => (
            <button
              ...
              style={{
                ...
                borderColor: mode === m ? '#111111' : '#E5E7EB'
              }}
            >
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] font-bold text-[#111111]/60">Interface</span>
          {(['touch', 'controller'] as const).map((v) => (
            <button
              ...
              className="rounded-lg border px-2.5 py-1 text-[10px] font-extrabold cursor-pointer transition-all"
              style={{
                background: iface === v ? '#111111' : '#FFFFFF',
                color: iface === v ? '#FFFFFF' : '#111111',
                borderColor: iface === v ? '#111111' : '#E5E7EB'
              }}
            >
        ...
        {inFlight ? (
          <>
            <div className="mb-2 flex items-center justify-between">
              <p className="text-[9px] font-extrabold uppercase tracking-[0.14em] text-[#111111]/60">Your pipeline</p>
              <span className="text-[9px] font-mono text-[#111111]/40">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              ...
              disabled={busy}
              className="shrink-0 rounded-lg bg-[#111111] px-3.5 py-2 text-[11px] font-extrabold text-[#FFFFFF] cursor-pointer disabled:opacity-40"
            >
