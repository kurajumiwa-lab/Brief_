            ...
            {banner.share.available ? (
              <>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="inline-flex min-h-9 items-center gap-1.5 rounded-lg border border-[#FFFFFF]/30 px-3 py-2 text-[10px] font-extrabold text-[#FFFFFF]"
                >
                  <ExternalLink className="h-3.5 w-3.5" /> View campaign
                </a>
              </>
            ) : (
              <span className="rounded-lg border border-[#FFFFFF]/25 px-3 py-2 text-[10px] font-bold text-[#FFFFFF]/70">
