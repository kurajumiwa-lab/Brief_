...
export function WireSection() {
  ...
  return (
    <section className="space-y-3 rounded-2xl border border-[#E5E7EB] bg-[#FAFAFA] p-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h2 className="px-1 text-[11px] font-bold uppercase tracking-[0.22em] text-[#111111]/60">News</h2>
          <p className="mt-1 px-1 text-[10px] leading-snug text-[#111111]/45">
        ...
        <button
          ...
          disabled={refreshing}
          className="min-h-9 rounded-lg border border-[#E5E7EB] bg-[#FFFFFF] px-3 py-1.5 text-[10px] font-extrabold text-[#111111] disabled:opacity-50"
        >
      ...
      {wire?.error && (
        <p className="rounded-xl border border-dashed border-[#E5E7EB] bg-[#FFFFFF] px-3 py-2 text-[10px] leading-snug text-[#111111]/60">
          The live news request returned an error: {wire.error}
        </p>
      )}

      {headlines.length === 0 ? (
        <div className="rounded-xl border border-dashed border-[#E5E7EB] bg-[#FFFFFF] px-3 py-3">
          <p className="text-[11px] font-extrabold text-[#111111]">No current news returned.</p>
        ...
        <>
          {wire?.kenya?.length ? (
            <div className="space-y-2">
              <p className="px-1 text-[9px] font-extrabold uppercase tracking-[0.16em] text-[#111111]/45">Kenya</p>
          ...
          {wire?.world?.length ? (
            <div className="space-y-2">
              <p className="px-1 text-[9px] font-extrabold uppercase tracking-[0.16em] text-[#111111]/45">World</p>
              <div className="grid gap-2 sm:grid-cols-2">
