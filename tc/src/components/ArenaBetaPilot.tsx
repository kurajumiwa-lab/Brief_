  ...
  return (
    <div className="rounded-xl border border-[#D6CFE4] bg-[#FBFAFD] p-3">
      <div className="flex items-baseline justify-between gap-2">
        <span className="text-[10px] font-bold text-[#251045]/60">{label}</span>
        <span className="font-mono text-[12px] font-extrabold text-[#251045]">
          {known ? value : '—'} <span className="font-sans text-[9px] font-bold text-[#251045]/40">/ {target}</span>
        </span>
      </div>
      <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-[#E9E4F2]">
        <div className="h-full rounded-full bg-[#5B2EA6] transition-all" style={{ width: `${pct}%` }} />
      </div>
      <p className="mt-1.5 text-[9px] text-[#251045]/40">pilot target</p>
    </div>
  );
}
...
export function ArenaBetaPilot({
  ...
  return (
    <section className="space-y-4" aria-labelledby="arena-beta-title">
      ...
      <div className="overflow-hidden rounded-[26px] border border-[#6C3EC9] bg-[#5B2EA6] text-[#FFFFFF]">
        <div className="relative px-5 pb-5 pt-5 sm:px-6 sm:pb-6 sm:pt-6">
          <div aria-hidden="true" className="pointer-events-none absolute -right-8 -top-12 h-40 w-40 rounded-full border border-[#FFFFFF]/15" />
          <div aria-hidden="true" className="pointer-events-none absolute -right-1 -top-5 h-24 w-24 rounded-full border border-[#FFFFFF]/10" />
          <div className="relative max-w-xl">
            <div className="flex flex-wrap items-center gap-2 text-[9px] font-extrabold uppercase tracking-[0.18em] text-[#FFFFFF]/65">
              <span className="rounded-full border border-[#FFFFFF]/25 px-2 py-1 text-[#FFFFFF]">Controlled beta</span>
            ...
            <p className="mt-3 max-w-lg text-[13px] leading-relaxed text-[#FFFFFF]/72">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
              <button
                ...
                className="brief-tap inline-flex min-h-11 items-center gap-2 rounded-xl bg-[#FBFAFD] px-4 py-2.5 text-[12px] font-extrabold text-[#251045] disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                className="brief-tap inline-flex min-h-11 items-center gap-2 rounded-xl border border-[#FFFFFF]/30 px-4 py-2.5 text-[12px] font-extrabold text-[#FFFFFF]"
              >
                {copied ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                {copied ? 'Invite copied' : 'Copy invite'}
              </button>
            </div>
            <p className="mt-3 text-[10px] text-[#FFFFFF]/50">
              Free entry. No cash prize or payment rail is promised yet. The first job is proving that players show up and play.
            </p>
          </div>
        </div>

        <div className="grid gap-3 border-t border-[#FFFFFF]/15 bg-[#FBFAFD] p-4 text-[#251045] sm:grid-cols-3 sm:p-5">
          <div className="flex items-start gap-2">
            <Clock3 className="mt-0.5 h-4 w-4 shrink-0" />
            <div>
              <p className="text-[11px] font-extrabold">Tonight, 7–11pm</p>
              <p className="mt-0.5 text-[10px] leading-snug text-[#251045]/60">A human pairs the first players while we learn.</p>
            </div>
          </div>
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[10px] leading-snug text-[#251045]/60">64 players · one week · prize still to be confirmed.</p>
            </div>
          </div>
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[10px] leading-snug text-[#251045]/60">Only mutually confirmed results reach rankings.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-[#D6CFE4] bg-[#FBFAFD] p-4 sm:p-5">
        <div className="flex flex-wrap items-end justify-between gap-2">
          <div>
            <p className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#251045]">Pilot scoreboard</p>
            <h2 className="mt-1 text-[17px] font-extrabold tracking-[-0.02em]">Measure matches, not traffic.</h2>
          </div>
          <span className="text-[10px] text-[#251045]/45">
        ...
        {!summary && (
          <p className="mt-3 text-[10px] leading-snug text-[#251045]/50">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-2xl border border-[#D6CFE4] bg-[#FBFAFD] p-4 sm:p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#251045]">Choose your reason to play</p>
              <h2 className="mt-1 text-[17px] font-extrabold">Which player are we building for?</h2>
            </div>
            <Target className="h-5 w-5 shrink-0 text-[#251045]/55" />
          </div>
            ...
            {SEGMENTS.map((item) => {
              ...
              return (
                <button
                  ...
                  style={{
                    borderColor: active ? '#251045' : '#D6CFE4',
                    background: active ? '#251045' : '#FFFFFF',
                    color: active ? '#FFFFFF' : '#251045'
                  }}
                >
          ...
          <div className="mt-3 rounded-xl bg-[#E9E4F2] p-3">
            <p className="text-[9px] font-extrabold uppercase tracking-[0.16em] text-[#251045]/50">Message to test</p>
            <p className="mt-1 text-[12px] font-extrabold text-[#251045]">“{selected.message}”</p>
          </div>
          {joined && (
            <div className="mt-3 flex flex-wrap items-center justify-between gap-2 rounded-xl border border-[#6C3EC9] px-3 py-2.5">
              ...
              <button
                ...
                className="inline-flex min-h-9 items-center gap-1 rounded-lg bg-[#5B2EA6] px-3 py-1.5 text-[10px] font-extrabold text-[#FFFFFF]"
              >
        ...
        <div className="rounded-2xl border border-[#D6CFE4] bg-[#FBFAFD] p-4 sm:p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#251045]">Tonight’s runbook</p>
              <h2 className="mt-1 text-[17px] font-extrabold">Concierge first. Automate later.</h2>
            </div>
            <ClipboardList className="h-5 w-5 shrink-0 text-[#251045]/55" />
          </div>
          <ol className="mt-4 space-y-3">
            {[
              ...
              <li key={number} className="flex gap-3">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#5B2EA6] font-mono text-[9px] font-extrabold text-[#FFFFFF]">{number}</span>
                <div>
                  <p className="text-[11px] font-extrabold text-[#251045]">{title}</p>
                  <p className="mt-0.5 text-[10px] leading-snug text-[#251045]/60">{body}</p>
                </div>
              </li>
            ))}
          </ol>
      ...
      <div className="rounded-2xl border border-[#D6CFE4] bg-[#FBFAFD] p-4 sm:p-5">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <p className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#251045]">Recruiting plan · first 100</p>
            <h2 className="mt-1 text-[17px] font-extrabold">Recruit where eFootball already happens.</h2>
          </div>
          <span className="rounded-full bg-[#E9E4F2] px-2.5 py-1 text-[10px] font-extrabold text-[#251045]">Targets, not results</span>
        </div>
        <div className="mt-4 divide-y divide-[#D6CFE4]">
          {RECRUITING_CHANNELS.map((channel) => (
            <div key={channel.label} className="flex items-center gap-3 py-3 first:pt-0 last:pb-0">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#5B2EA6] text-[#FFFFFF]">
                <MessageCircle className="h-4 w-4" />
              </div>
              <div className="min-w-0 flex-1">
                <div className="flex flex-wrap items-baseline justify-between gap-2">
                  <p className="text-[11px] font-extrabold text-[#251045]">{channel.label}</p>
                  <span className="font-mono text-[10px] font-extrabold text-[#251045]">{channel.target} target</span>
                </div>
                <p className="mt-0.5 text-[10px] leading-snug text-[#251045]/55">{channel.detail}</p>
              </div>
            </div>
          ))}
        </div>
        <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-[#D6CFE4] pt-4">
          <Share2 className="h-4 w-4 text-[#251045]/55" />
          <p className="flex-1 text-[10px] leading-snug text-[#251045]/60">
            Lead with the competition: “Join the first eFootball Arena beta. Play, get ranked, and compete with other players.”
          </p>
          <button
            type="button"
            onClick={() => void copyInvite()}
            className="inline-flex min-h-9 items-center gap-1 rounded-lg border border-[#6C3EC9] px-3 py-1.5 text-[10px] font-extrabold text-[#251045]"
          >
      ...
      <div className="rounded-2xl border border-[#D6CFE4] bg-[#FBFAFD] p-4 sm:p-5">
        <p className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#251045]">What the first week should teach us</p>
        <div className="mt-3 grid gap-3 sm:grid-cols-3">
          <div>
            <p className="text-[11px] font-extrabold text-[#251045]">Return</p>
            <p className="mt-1 text-[10px] leading-snug text-[#251045]/60">Do players complete 2–3 matches and come back next week?</p>
          </div>
          <div>
            <p className="text-[11px] font-extrabold text-[#251045]">Competition</p>
            <p className="mt-1 text-[10px] leading-snug text-[#251045]/60">Do they ask for ranked play, tournaments, leaderboards, or prizes?</p>
          </div>
          <div>
            <p className="text-[11px] font-extrabold text-[#251045]">Business signal</p>
            <p className="mt-1 text-[10px] leading-snug text-[#251045]/60">Only after free play: would players pay a small fee, or would a sponsor help?</p>
          </div>
        </div>
      </div>

      <p className="flex items-start gap-2 px-1 text-[10px] leading-snug text-[#251045]/50">
        <CheckCircle2 className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#251045]" />
