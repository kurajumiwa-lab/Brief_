...
ALL="access apic arena batch1 camp circleops capture commerce chain dest econ engine group groupui inbox ing loops nav news orchestration parse person pmatch pure pursuit quests routes session stories sys"
SUITES="${*:-$ALL}"
