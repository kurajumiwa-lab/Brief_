...
ALL="access apic arena batch1 camp circleops capture commerce chain dest econ group groupui inbox ing loops nav parse pmatch pure pursuit quests routes session sys"
SUITES="${*:-$ALL}"
