...
ALL="access apic arena ligi batch1 camp circleops capture commerce chain dest econ engine group groupui inbox ing loops media nav news onboard orchestration parse person pmatch pure pursuit quests routes session stories sys"
SUITES="${*:-$ALL}"
