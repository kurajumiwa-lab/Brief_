...
ALL="access admin alerts apic arena gate batch1 camp circleops capture commerce chain dest econ engine group groupui inbox ing joins loops media nav news onboard orchestration parse person pmatch pure pursuit quests resale routes session stories sys"
SUITES="${*:-$ALL}"
