  ...
  return (
    <section className="space-y-4">
      ...
      {detail.status === 'loading' && (
        <p className="text-xs text-[#111111]/60 mt-2">Loading...</p>
      )}

      {detail.status === 'error' && (
        <p className="text-[11px] text-[#111111] mt-2">
        ...
        <>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-[10px] font-extrabold cursor-pointer ${
                  section === s.id
                    ...
                    : 'bg-[#FFFFFF] border border-[#E5E7EB] text-[#111111]/60'
                }`}
              >
                {s.label}
              </button>
          ...
          {section === 'overview' && (
            <div className="space-y-4">
              {open.goal && (
                <div>
                  <h3 className="text-[11px] font-extrabold text-[#111111]/40 mb-1">
                    Purpose
                  </h3>
                  <p className="text-[11px] text-[#111111] leading-snug">{open.goal}</p>
                </div>
              )}
              ...
              <div>
                ...
                {detail.blocks.filter((b) => b.type !== 'task' && b.type !== 'vote')
                  .length === 0 ? (
                  <p className="text-xs text-[#111111]/60">Nothing posted yet.</p>
                ) : (
                  <div className="space-y-2">
                    {detail.blocks
                      ...
                      .map((block) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-[#111111] mt-1">{block.content}</p>
