    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-sm font-extrabold text-[#0D1117]">{circle.name}</p>
        ...
        <div className="shrink-0 flex items-center gap-1.5">
          ...
          {mode === 'mine' && (
            <button
              ...
              disabled={busyId === circle.id}
              className="px-3 py-1.5 rounded-xl border border-[#E5E8EC] text-[10px] font-bold text-[#0D1117]/60 cursor-pointer disabled:opacity-50"
            >
      ...
      <section className="space-y-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            className="shrink-0 px-3 py-2 rounded-xl bg-[#FF5A1F] text-[#0D1117] font-extrabold text-[10px] cursor-pointer"
          >
        ...
        {notice && (
          <div className="border border-[#E5E8EC] bg-[#FFFFFF] rounded-xl px-3 py-2">
            <p className="text-[10px] text-[#0D1117] leading-snug">{notice}</p>
          </div>
        )}
        ...
        {showCreate && (
          ...
          >
            <input
              ...
              className="w-full rounded-xl border border-[#E5E8EC] px-3 py-2 text-[12px] text-[#0D1117]"
            />
            <input
              value={newGoal}
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-[#FF5A1F] text-[#0D1117] font-extrabold text-[10px] cursor-pointer disabled:opacity-50"
            >
        ...
        {mine.length > 0 && (
          <div className="space-y-2">
            <h3 className="text-[11px] font-extrabold uppercase tracking-[0.14em] text-[#0D1117]/60">
        ...
        {list.status === 'ready' && mine.length === 0 && circles.length > 0 && (
          <div className="border border-dashed border-[#E5E8EC] rounded-2xl p-6 text-center">
            <p className="text-xs text-[#0D1117]/60">
  ...
  return (
    <section className="space-y-4">
      ...
      {detail.status === 'loading' && (
        <p className="text-xs text-[#0D1117]/60 mt-2">Loading...</p>
      )}

      {detail.status === 'error' && (
        <p className="text-[11px] text-[#0D1117] mt-2">
      ...
      {detail.status === 'ready' && open && (
        <>
          <div className="mt-2 flex items-start justify-between gap-3">
            <div className="min-w-0">
              <h2 className="text-lg font-extrabold text-[#0D1117]">{open.name}</h2>
              <p className="text-[9px] text-[#0D1117]/60 mt-0.5">
            ...
            {myRole ? (
              <button
                ...
                className="shrink-0 px-3 py-1.5 rounded-xl border border-[#E5E8EC] text-[10px] font-bold text-[#0D1117]/60 cursor-pointer disabled:opacity-50"
              >
              ...
              <span className="shrink-0 text-[10px] text-[#0D1117]/60">
                Invite only
              </span>
            )}
          </div>
          ...
          {section === 'overview' && (
            <div className="space-y-4">
              {open.goal && (
                <div>
                  <h3 className="text-[11px] font-extrabold text-[#0D1117]/60 mb-1">
                    Purpose
                  </h3>
                  <p className="text-[11px] text-[#0D1117] leading-snug">{open.goal}</p>
                </div>
              )}
              ...
              <div>
                ...
                {detail.blocks.filter((b) => b.type !== 'task' && b.type !== 'vote')
                  .length === 0 ? (
                  <p className="text-xs text-[#0D1117]/60">Nothing posted yet.</p>
                ) : (
                  <div className="space-y-2">
                    {detail.blocks
                      ...
                      .map((block) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-[#0D1117] mt-1">{block.content}</p>
