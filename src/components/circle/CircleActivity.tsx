      ...
      {rows.length === 0 ? (
        ...
        <div className="space-y-1.5">
          {rows.map((signal) => (
            <div
              key={signal.id}
              className="flex items-center gap-3 bg-[#FFFFFF] border border-[#E5E8EC] rounded-xl px-3 py-2"
            >
              <span className="text-[10px] text-[#0D1117] min-w-0 truncate">
              ...
              <span className="text-[9px] text-[#0D1117]/60 shrink-0 ml-auto">
