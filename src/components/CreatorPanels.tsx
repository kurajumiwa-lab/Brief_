      ...
      {state === 'loading' ? <Empty text="Loading…" /> : (
        <>
          <div className="rounded-xl border p-4 space-y-3" style={{ borderColor: T.outlineVariant, background: T.container }}>
            ...
            <button type="button" disabled={busy || !form.fullName.trim()} onClick={() => void saveProfile()} className="rounded-full px-4 py-2 text-[11px] font-bold cursor-pointer disabled:opacity-40" style={{ background: T.primary, color: '#0D1117' }}>Save profile</button>
          </div>
            ...
            <div key={o.id} className="rounded-xl border p-3" style={{ borderColor: T.outlineVariant, background: T.container }}>
              ...
              {o.status === 'pending' && (
                <div className="mt-2 flex gap-1">
                  <button onClick={() => void respond(o.id, 'accept')} className="flex items-center gap-1 rounded-full px-3 py-1 text-[11px] font-bold cursor-pointer" style={{ background: T.primary, color: '#0D1117' }}>
      ...
      <div className="flex gap-1.5">
        <button
          ...
          style={{
            ...
            color: mode === 'mine' ? '#0D1117' : T.onSurfaceVariant,
        ...
        <button
          ...
          style={{
            ...
            color: mode === 'join' ? '#0D1117' : T.onSurfaceVariant,
            border: `1px solid ${T.outlineVariant}`
          }}
        >
          Plans I can join
        ...
        <button
          ...
          style={{
            ...
            color: mode === 'topics' ? '#0D1117' : T.onSurfaceVariant,
            border: `1px solid ${T.outlineVariant}`
          }}
        >
          Email lists
      ...
      {mode === 'mine' && (
        <>
          <div className="flex gap-2">
            ...
            <button onClick={() => void create()} disabled={busy || !title.trim() || !price} className="rounded-lg px-3 py-2 text-[12px] font-bold cursor-pointer disabled:opacity-40" style={{ background: T.primary, color: '#0D1117' }}>
          ...
          <div className="rounded-xl border p-3 space-y-2" style={{ borderColor: T.outlineVariant, background: T.container }}>
            ...
            <div className="flex gap-2">
              <input
                ...
                style={{ borderColor: T.outlineVariant, background: T.container, color: T.onSurface }}
              />
              <button onClick={() => void confirm()} disabled={topicBusy || !confirmToken.trim()} className="rounded-lg px-3 py-2 text-[11px] font-bold cursor-pointer disabled:opacity-40" style={{ background: T.primary, color: '#0D1117' }}>
                Confirm
              </button>
            </div>
          </div>
