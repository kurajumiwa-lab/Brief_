...
export function createArticle({
  ...
  relatedContent = [], relatedPlaces = [], relatedEvents = []
}) {
...
export function updateArticle(id, patch) {
  ...
  const allowed = ['title', 'dek', 'body', 'category', 'subCategory', 'location', 'heroImage', 'images', 'author', 'source', 'sourceUrl', 'readingTime', 'tags', 'entities', 'relatedContent', 'relatedPlaces', 'relatedEvents', 'publishedAt', 'expiresAt'];
  const next = {};
